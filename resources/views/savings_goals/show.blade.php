                ...
                <main class="space-y-5">
                    ...
                    <div class="grid gap-4 md:grid-cols-3">
                        <div class="ui-card rounded-lg border border-sky-100 bg-sky-50 p-5 shadow-sm hover:border-sky-200 min-w-0">
                            ...
                            <p class="mt-3 text-xl font-bold text-sky-700 break-all sm:text-2xl lg:text-lg xl:text-2xl">Rp{{ number_format($savingsGoal->current_amount, 0, ',', '.') }}</p>
                        </div>
                        ...
                        <div class="ui-card rounded-lg border border-slate-200 bg-white p-5 shadow-sm hover:border-slate-300 min-w-0">
                            ...
                            <p class="mt-3 text-xl font-bold text-slate-950 break-all sm:text-2xl lg:text-lg xl:text-2xl">Rp{{ number_format($savingsGoal->target_amount, 0, ',', '.') }}</p>
                        </div>
                        ...
                        <div class="ui-card rounded-lg {{ max(0, $savingsGoal->target_amount - $savingsGoal->current_amount) <= 0 ? 'border-emerald-100 bg-emerald-50' : 'border-amber-100 bg-amber-50' }} p-5 shadow-sm min-w-0">
                            ...
                            <p class="mt-3 text-xl font-bold {{ max(0, $savingsGoal->target_amount - $savingsGoal->current_amount) <= 0 ? 'text-emerald-700' : 'text-amber-700' }} break-all sm:text-2xl lg:text-lg xl:text-2xl">Rp{{ number_format(max(0, $savingsGoal->target_amount - $savingsGoal->current_amount), 0, ',', '.') }}</p>
                        </div>
                    </div>
