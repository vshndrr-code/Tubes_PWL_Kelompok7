            ...
            <aside class="space-y-5">
                <section class="ui-reveal overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm">
                    <div class="bg-slate-950 p-5 text-white">
                        ...
                        <p class="mt-1 text-sm text-slate-400">Lihat bagaimana tag akan tampil di transaksi.</p>
                    </div>
                ...
                <section class="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
                    <p class="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">Tips</p>
                    <ul class="mt-4 space-y-3 text-sm text-slate-600">
                        ...
                        <li class="flex items-start gap-2">
                            ...
                            Tag bisa dipakai di banyak transaksi sekaligus
                        </li>
                    </ul>
                </section>
            </aside>
