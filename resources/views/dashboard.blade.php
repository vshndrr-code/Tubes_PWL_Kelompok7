    ...
    <div class="min-h-screen bg-[#f6f7f9] text-slate-900">
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 sm:py-10 lg:px-8">
            ...
            <div class="mb-5 grid gap-4 md:grid-cols-3">
                ...
                <a href="{{ $budgetUrl }}" class="ui-card block rounded-lg border border-slate-200 bg-white p-5 shadow-sm hover:border-slate-300 hover:shadow-md transition">
    ...
    <section class="rounded-xl border border-slate-200 bg-white shadow-sm overflow-hidden">
        ...
        <div
            ...
            <a href="{{ route('transactions.index') }}"
                class="ui-button inline-flex h-9 items-center justify-center gap-1.5 rounded-lg border border-slate-200 bg-white px-3 text-xs font-semibold text-slate-700 shadow-sm hover:border-slate-300 hover:bg-slate-50 transition">
                Lihat Semua
            ...
            <div class="divide-y divide-slate-100">
                ...
                @foreach ($recentItems as $transaction)
                    ...
                    <a href="{{ route('transactions.show', $transaction) }}"
                        class="flex flex-col gap-3 px-5 py-4 transition hover:bg-slate-50 sm:flex-row sm:items-center sm:justify-between block">
            ...
            <div class="mt-4 space-y-3">
                ...
                @forelse ($accountItems->sortByDesc('balance')->take(3) as $account)
                    ...
                    <a href="{{ route('accounts.show', $account) }}"
                        class="flex items-center justify-between rounded-lg bg-slate-50 p-3 hover:bg-slate-100 transition duration-150 block">
