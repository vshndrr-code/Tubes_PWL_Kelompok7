                ...
                <div class="overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-sm">
                    <table class="min-w-full divide-y divide-slate-200 text-sm text-slate-700">
                        <thead class="bg-slate-50 text-slate-500">
                            <tr>
                                <th scope="col"
                                    class="px-6 py-4 text-left font-semibold tracking-[0.16em] uppercase">Wallet</th>
                                <th scope="col"
                                    class="px-6 py-4 text-left font-semibold tracking-[0.16em] uppercase">Type</th>
                                <th scope="col"
                                    class="px-6 py-4 text-left font-semibold tracking-[0.16em] uppercase">Balance</th>
                                <th scope="col"
                                    class="px-6 py-4 text-left font-semibold tracking-[0.16em] uppercase">Transactions
                                </th>
                                <th scope="col"
                                    class="px-6 py-4 text-right font-semibold tracking-[0.16em] uppercase">Actions</th>
                            </tr>
                        </thead>
                                    ...
                                    <td class="px-6 py-5 text-right align-middle">
                                        <div class="flex items-center justify-end gap-2">
                                            <a href="{{ route('accounts.edit', $account) }}"
                                                class="flex h-11 w-11 items-center justify-center rounded-2xl border border-slate-200 bg-slate-50 text-slate-900 transition hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-slate-400/20 leading-none">
                                                <svg class="h-5 w-5 text-slate-700 translate-y-px" viewBox="0 0 24 24"
                                            ...
                                            <form action="{{ route('accounts.destroy', $account) }}" method="POST"
                                                ...
                                                <button type="submit" onclick="return confirm('Hapus akun ini?')"
                                                    class="flex h-11 w-11 items-center justify-center rounded-2xl border border-red-200 bg-red-50 text-red-700 transition hover:bg-red-100 focus:outline-none focus:ring-2 focus:ring-red-400/20 leading-none appearance-none">
                                                    <svg class="h-5 w-5 text-red-700" viewBox="0 0 24 24"
                                                        fill="none" stroke="currentColor" stroke-width="2"
                                                        stroke-linecap="round" stroke-linejoin="round">
                                                        <path d="M3 6h18" />
