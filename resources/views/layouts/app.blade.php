        ...
        <div class="min-h-screen flex">
            ...
            <aside class="w-64 bg-white shadow-lg">
                <div class="p-6 border-b border-gray-200">
                    <a href="{{ route('dashboard') }}" class="flex items-center space-x-3 mb-2">
                        <div class="flex items-center justify-center w-12 h-10 flex-shrink-0">
                            <svg class="w-12 h-10" viewBox="0 0 320 240" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <!-- Arrow up-right (teal) -->
                        ...
                        <div>
                            <h1 class="text-xl font-bold text-gray-800 leading-none">MOMA</h1>
                            <p class="text-xs text-gray-500">Financial Tracker</p>
                        </div>
                    </a>
                </div>
