            ...
            <form action="{{ route('budgetings.store') }}" method="POST" class="space-y-0">
                ...
                <div class="space-y-6 px-6 py-8 sm:px-8 sm:py-10">
                    ...
                    <div>
                        ...
                        <div class="mt-3">
                            <x-category-selector :categories="$categories" :selected-category-id="old('category_id', request('category'))" />
                        </div>
                        @error('category_id')
                    ...
                    <div>
                        ...
                        <div class="relative mt-3">
                            ...
                            <input id="limit_amount" name="limit_amount" type="number" step="0.01" value="{{ old('limit_amount') }}" required
